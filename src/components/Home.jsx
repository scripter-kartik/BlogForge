      ...
      <div className="w-full max-w-7xl px-4 sm:px-6 lg:px-8 mt-20 sm:mt-28 lg:mt-32 h-auto">
        ...
        >
          ...
          <button
            ...
            className={`px-4 py-2 border rounded ${isDarkMode ? "border-white hover:bg-white hover:text-black" : "border-black hover:bg-black hover:text-white"}`}
          >
            Retry
          </button>
        </div>
    ...
    <div className="w-full max-w-7xl px-4 sm:px-6 lg:px-8 mt-20 sm:mt-28 lg:mt-32 h-auto mb-20 md:mb-0">
      {isAuthenticated ? (
        ...
        >
          ...
          {userStats && (
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 lg:gap-6">
              <div
                className={`flex flex-col gap-2 border-[1px] ${isDarkMode ? "border-[#494949]" : "border-[#dbdada]"} shadow-lg w-full h-[135px] rounded-xl p-5`}
              >
          ...
          <button
            ...
            className={`border-[1px] ${isDarkMode ? "border-white hover:bg-white" : "border-black hover:bg-black hover:text-white"} rounded-full px-6 py-[8px] mt-2 hover:text-black hover:animate-pulse w-full sm:w-[200px] h-[50px] text-base sm:text-lg transition-all`}
          >
            Write a post
          </button>
        </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start gap-8 lg:gap-4">
          ...
          <div
            className={`order-2 lg:order-1 flex flex-col gap-4 sm:gap-6 items-center lg:items-start mt-0 sm:mt-4 lg:mt-[28px] ${isDarkMode ? "text-white" : "text-black"} text-center lg:text-left`}
          >
            <div className="flex flex-col gap-2 font-bold">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl">
                Where developers
              </h1>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl text-[#f75555]">
                Build, Write, and Share
              </h1>
            </div>
            ...
            <button
              onClick={() => setIsLoginActive(true)}
              className={`border-[1px] ${isDarkMode ? "border-white hover:bg-white" : "border-black hover:bg-black hover:text-white"} rounded-full px-6 py-[8px] mt-2 hover:text-black hover:animate-pulse transition-all`}
            >
              Join the community
            </button>
          </div>

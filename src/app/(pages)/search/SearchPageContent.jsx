      ...
      <div className="w-full max-w-7xl px-4 sm:px-6 lg:px-8 mt-24 sm:mt-28 lg:mt-32 mb-20">
        ...
        {!loading && !error && (
          <>
            <div className="mt-14">
              <h2
                className={`${textClass} text-2xl sm:text-3xl font-bold mb-6`}
              >
                ...
                <div className="flex flex-col gap-6">
                  {results.posts.map((p) => (
                    ...
                    >
                      ...
                      {p.description && (
                        <p
                          className={`mt-2 text-sm ${isDarkMode ? "text-gray-300" : "text-gray-600"} line-clamp-2`}
                        >
                          {p.description}
                        </p>
                      )}
            ...
            {results.posts.length === 0 &&
              ...
              !loading && (
                <p
                  className={`text-center mt-20 text-lg ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}
                >

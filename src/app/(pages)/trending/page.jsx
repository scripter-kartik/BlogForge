...
export default function TrendingPage() {
    ...
    const renderPosts = (posts) => {
        ...
        return posts.map((post) => (
            ...
            >
                <div
                    className={`flex flex-col md:flex-row gap-4 md:gap-6 p-4 md:p-6 rounded-xl transition-all duration-300 hover:shadow-xl hover:scale-[1.01] ${isDarkMode
                        ? "bg-[#2D2D2D] text-white hover:bg-[#353535]"
                        : "bg-[#E8EAEC] text-black hover:bg-[#dfe1e4]"
                        }`}
                >
                    {post.coverImage && (
                        <img
